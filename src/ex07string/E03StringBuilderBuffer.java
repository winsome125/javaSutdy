...
/*
 StringBuffer클래스
  ...
  문자열의 변경이 많은 경우에는 StringBuffer 클래스를 사용하는것이 좋다.
...
public class E03StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		/* String 클래스는 문자열의 변경이 있는 경우 기존 메모리를 소멸하고 새로운 메모리를 할당한다. */
		str1 = str1 + "&Spring";
		if(str1==str2)
		...
		/* StringBuffer 믈래스는 문자열을 저장하기 위해 기본 메모리를 16으로 할당한다. 
		   차후 지정할 공간이 부족하면 자동으로 메모리를 확장한다. */

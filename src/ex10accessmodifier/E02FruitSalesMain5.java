...
class FruitSeller6{
	...
	/* 
	 ...
	 이렇게 하면 클래스 내부에서만 접근할 수 있고 외부에서의 접근은 원천적으로 차단할 수 있다.
	 */
...
////////////////////////////////////////////////////
		/*
		 멤버변수를 private으로 선언하면 클래스 외부에서는 접근이 불가능 하므로 아래 코드는 에러가 발생하게된다.
		 (이부분은 주석으로 처리한다)
		 즉, 멤버변수의 정보은닉을 통ㄹ해 비정상적인 접근을 차단하고 멤버메서드를 통서만 구매가 이루어질 수 있록 구현해야한다.
		 */

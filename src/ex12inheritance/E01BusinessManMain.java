...
/*
 상속(Inheritance)
  : 기존에 저의된 클래스에 메서드와 변수를 추가하여 새로운 클래스를 정의하는 것을 말한다.
...
class BusinessMan extends Man {
	...
	// 새성자 : 맴버변수는 2개지만 매개변수는 3개로 선언한다.
	public BusinessMan(String name, String company, String position) {
		/*
		 상속받은 자식클래스는 부모클래스의 생성자를 호출하여 부모객체가 메모리에 먼저 생성되도록 해야한다.
	...
	public void tellYourInfo() {
		...
		/* 
		 부모클래스의 멤버변수 name은 private으로 선언되었으므로 상속받은 자식클래스에서 접근할 수 없다.

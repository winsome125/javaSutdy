...
/*
 가변인자(Variable Argument)
  : 매서드 오버로딩을 대체할 수 있는 문법으로 하나의 메서드로 여러가지 호출형식을 대체할 수 있다.
  형식]
     메서드명(자료형 ... 매개변수명) {
           실행문장;
     }
     - 필요에 따라 매개변수를 가변적으로 조정할 수 있는 문법
     - 매개변수를 2개이상 바을 수 있어야 하므로 배열로 반환
     - 단, 자료형은 모두 동일해야 한다.
 */
...
//	static int gerTotal(int param1, int param2, int param3) {
//		int total = 0;
...
//	}
	...
	public static void main(String[] args) {
		...
		/*
		 매개변수 타입이 double이 포함되어 있으므로 호출할 수 없다.
		 만약 아래와 같이 실수를 모두 처리하려면 가변인자의 타입을 double로 선언하면 된다.
		 */

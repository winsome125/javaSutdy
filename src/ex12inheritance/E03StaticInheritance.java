...
class Adder {
	...
	/*
	 static으로 선언된 멤버변수는 실제로 클래스외부(Method)에 생성되어 있으므로 클래스명을 통한 접근이 허용된다.
	 코드 레벨에서 보면 해당 클래스의 멤버변수이므로 변수명 만으로 접근하는것도 가능하다.
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		/*
		 앞에서 호출한 메서드는 모두 메서드영역에 생성된 정적변수 val에 더해지게 되므로 출력결과는 20이 된다.
		 */
		adFriend.showVal();

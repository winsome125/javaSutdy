...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		 저장할 Student인스턴스 생성.
		 외부패키지에 선언되었으므로 반드시 import후 사용해야 한다.
		 */
		Student st1 = new Student("정우성", 18, "2018");
		...
		for(int i=0 ; i<list2.size() ; i++) {
			/*
			 ...
			 만약 오버라이딩이 되어있지 않다면 참조값이 출력될것이다.
			 */
		...
		/*
		 ...
		 또한 동일한 인스턴스가 존대한다면 앞에 있는것이 먼저 삭제된다.
		 즉 동시에 삭제되지 않는다.
		 */
		...
		for(Student st : list2) {
			/*
			 ...
			 삭제를 위해 입력한 이름과 Student객체에 저장된 name과 일치하는지 확인한 후 해당 인스턴스를 찾을 수 있다.
			 */

...
public class Ex08AsList {
	...
	public static void ListPrint(String title, List<String> list) {
		...
		/*
		 ...
		 만약 우리가 직접 정의한 클래스라면 toString()을 오버라이딩 해야한다.
		 */
		for(Object ob : list) {
			System.out.print(ob +" ");
		}
	...
	public static void main(String[] args) {
		...
		/*
		 String객체배열을 생성과 동시에 초기화한다.
		 이 경우 초기데이터를 통해 크기를 유추할 수 있으므로 크기는 선언문장에서 생략해야한다.
		 */
		String[] strArr = new String[] {"마린", "파이어뱃", "메딕", "마린"};
		/*
		 Array.asList()
		  : 일반적인 배열을 List<E> 컬ㄹ렉션으로 변경한 후 반환한다.
		  단, 값을 참조만 할수있고 입력이나 삭제는 할수없다.
		 */

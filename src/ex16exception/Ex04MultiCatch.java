...
/*
 ...
 Exception 클래스는 모든 예외를 catch할 수 있으므로 반드시 마지막 블럭에 사용해야한다.
...
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 Exception 클래스는 모든 예외클래스의 부모이므로 catch절의 마지막에 기술해야한다.
			 위쪽으로 이동시키면 에러가 발생된다.
			 해당 클래스로 모든 예외를 catch할수 있기때문이다.
			 */
		...
		/*
		 앞에서 예외가 발생하더라도 예외처리를 했으므로 프로그램은 끝까지 실행된 후 정상적으로 종료된다.

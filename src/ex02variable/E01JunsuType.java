...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		 ...
		 -일반적으로 CPU(중앙처리장치)느 정수형 연산을 할때 int형을 가장 빠르게 처리한다.
		...
		/*
		 100/200의 결과는 0이 나오게 된다. Java에서는 정수의 정수를 연산하면 정수의 결과가 반환된다.
		...
		/*
		 ...
		 - byte, short 타입은 게임 케릭터의 움직임이나 음원파일 등을 표현할때 주로 사용된다.
		 */
		...
		/*
		 ...
		 이때 접미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의 자료임을 컴파일러에게 알려줘야 한다.
		 이와같이 할당을 위해 입력되는 숫자도 자료형을 기반으로 메모리에 로드되느 이을 가르켜 리터럴(literal)이라고 한다. 
		 */

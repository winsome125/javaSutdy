...
public class E06EscapeSequence {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 /* 같은 출력문장이지만 println()을 사용하면 아래와 같이 문자열과 변수를 분리하여 기술해야하므로 조금 더 복잡하다. */
		 System.out.println("\n국어:"+ kor +",영어:"+ eng +", 수학:"+ math);
		 
		 /* 실수는 %f를 사용한다. 또한 정수와 실수의 연산이므로 결과는 실수가 반환되어 double 타입으로 선언한 변수에 대입할 수 있다. */
		 ...
		 /*
		  ...
		  %6.2f : 실수 출력시 전체자리수는 6자리, 소수이하 2자리로 표현한다. 또한 양수는 우측정렬, 음수는 좌측정렬된다.
		  */

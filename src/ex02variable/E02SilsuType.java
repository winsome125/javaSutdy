...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 - 정수보다는 실수형이 더 큰 자료형이다. 0과 1사이에 무수히 많은 실수가 존재하기 때문이다.
		 - 다라서 long(정수형)과 float(실수형)을 연산하면 float의 결과가 나오게된다.
		 */
		long long1 = 100;
		float float1 = 200;
		// 실수형으로 자동형변환된다.
		...
		/*
		 - 실수형의 기본은 double이다.
		 - 소수점이 있는 데이터를 검파일러는 무조건 double로 인식한다.
		 - 단, 소수점이 없는 데이터는 float에 대입할 수 있다.
		 - 소수점이 있는 데이터를 float에 대입하려면 점미사 F(혹은 f)를 붙여야한다.

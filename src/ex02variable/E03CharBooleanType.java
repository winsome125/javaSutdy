...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		char ch4 = '1';
		// 연산결과는 50이므로 이에 해당하는 문자는 '2'가 된
		char ch4_1 = '1'+ 1;
		// 문자 '2'와 정수 50이 출력된다.
		System.out.println("ch4="+ ch4+", ch4_1="+ ch4_1 +", ch4_1="+(int)ch4_1);
		
		/*
		 boolean타입 : true 혹은 false 두가지의 값만 가질수 있는 자료형으로 산술연산(+,-), 비교연산(<,<=)에서는 사용할 수 없고,
		 논리연산에서만 사용할 수 있다.
		 */
		boolean bn1 = true;
		boolean bn2 = false;
		...
		/*
		 ...
		 ||(논리Or) : 파이프를 사용하고, 둘 중 하나만 참이여도 참을 반환한다. 둘 다 거짓일때만 거짓을 반환한다.
		 */
		// T && F => false를 반환
		boolean bn3 = bn1 && bn2;

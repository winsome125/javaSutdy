...
/*
 Java에서 제공하는 함수형 인터페이스은 아래 4가지 정도가있다.
...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		/*
		 Predicate<T>
		  - 사전적의미 : ~에 근거를 두다
		  - 매개변수와 boolean리턴값이 있는 추상메서드 test()가 정의되어있다.
		  - 피라미터를 조사해 true / false를 반환한다.
		  ...
		  매개변수로 Human객체를 전달하고, 
		  getter인 getGender()를 통해 성별이 '남'인경우 true를 반환하도록 정의되어있다.
		 */
		...
		/*
		 ...
		 이와같은 람다식을 정의한 후 참조변수인 aaa를 전달하는것과 아래처럼 람다식 자체를 매개변수로 작성하는것은 동일하다.
		 */

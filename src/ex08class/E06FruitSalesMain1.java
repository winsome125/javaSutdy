...
class FruitSeller{
	...
	/*
	 멤버변수의 경우 초기값이 없은 상태로 정의한 후 인스턴스를 생성하고 차후 초기화할 수 있다.
	 하지만 멤버상수는 인스턴스 생성과 상관없이 ㅈ정의하는 시점에 반드시 초기화 해야한다.
...
public class E06FruitSalesMain1 {
	...
	public static void main(String[] args) {
		...
		// 구매자가 판매자에가 5000원을 지불하고 사과를 구매한다.

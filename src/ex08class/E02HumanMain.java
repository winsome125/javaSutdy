...
/*
 ...
 동일한 패키지에 정의되었다면 컴파일러는 해당 클래스를 찾아 즉시 인스턴스 화 할수있다.
 만약 다른 패키지에 선언된 클래스라면 반드시 import 선은을 해야한다.
 */
public class E02HumanMain {
	...
	public static void main(String[] args) {
		...
		/*
		 1.클래스를 통해 인스턴스를 생성한다. 참조변수(인스턴스형변수)는 스택영역에, 인스턴스 합영역에 생성된다.
		 */
		...
		human.eating();
		human.walking();
		human.showState(); // -> 맴버메서드 호출 후 객체 상태 확인

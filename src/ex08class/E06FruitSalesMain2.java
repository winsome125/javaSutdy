...
/* 
 첫번째 버전은 각 클래스의 멤버변수가 고정된 초기값으로 선언되어 상태가 다른 인스트ㅓㄴ스를 생성할 수 없다는 단점이 있었다.
...
class FruitSeller2{
	...
	int apple_price; // ctrl + shift + x => 대문자 / ctrl + shift + y => 소문자
	/*
	...
	public void showSaleResult() {
		System.out.println("[판매자]남은사가갯수:"+ numOfApple);

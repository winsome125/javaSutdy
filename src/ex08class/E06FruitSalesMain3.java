...
class FruitSeller3{
	...
	/*
	 멤버상수는 값으 변경이 불가능하고, 단 한번만 초기화되기 때문에 일반 멤버메서드에서는 초기화할 수 없다.
...
public class E06FruitSalesMain3 {
	...
	public static void main(String[] args) {
		...
		/*
		 생성자를 사용해서 인스턴스를 생성하면 생성과 동시에 초기화할수 있으므로 초기화 메서드를 사용하는것보다 적은 코드로 작성할 수 있다. 
		 */
		
		// FruitSeller2에서 생성 후 초기화를 했다면 FruitSeller3에서는 생성과 동시에 초기화 진행.
		...
		buyer.showBuyResult(); // 10000원을 내고 15개를 구매한다.

...
/*
 static 블럭
  : 동일 클래스내 main()메서드보다 먼저 실행되는 블럭으로 main()메서드의 실행코드가 없어도 먼저 실행된다.
  또한 생성자보다도 먼저 실행된다.
 */
...
public class E02StaticBlockMain {
	...
	static {
		...
		// 블럭내에 정적멤버변수에 접근할 수 있다.
		staticVar = 1000;		
 
		/*
		 블럭내에서만 사용할 수 있는 번수로써,
		 블럭내에서는 일반번수를 생성할 수 없다.
		 */
		int localVar;
		localVar = 1000;
	...
	public static void main(String[] args) {
		...
		/*
		 static블럭내에서 선언된 변수는 지역변수이므로 main()메서드에서는 사용할 수 없다.
		 해당 지역에서만 사용할 수 있다.
		 */
		// System.out.println("localVar="+ localVar);
